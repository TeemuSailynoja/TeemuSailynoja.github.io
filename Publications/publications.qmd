...
![](../assets/ecdf-paper.png){width=90% fig-align="center" fig-alt="Grid of six images. The first four show histograms of fractional ranks with per bin independent confidence bands for uniformity, and the two last show the empirical cumulative distribution of the fractional ranks with simultaneous confidence bands for uniformity."}
